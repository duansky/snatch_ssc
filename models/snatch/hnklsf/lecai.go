...
func init() {
	ioc.RegisterObj("snatch.ssc.hnklsf.lecai", &LecaiSnatch{base.DataProcesserAbs{Type: "hnklsf", Site: "lecai"}})
}

// 抓取网页
func (c *LecaiSnatch) Snatch() (string, error) {
	doc, err := goquery.NewDocument("http://baidu.lecai.com/lottery/draw/view/556")
